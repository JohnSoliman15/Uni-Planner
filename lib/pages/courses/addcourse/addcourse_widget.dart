...
class _AddcourseWidgetState extends State<AddcourseWidget> {
  ...
  void initState() {
    ...
    _model.professorNameFocusNode ??= FocusNode();
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              focusNode: _model.professorNameFocusNode,
                              obscureText: false,
                              decoration: InputDecoration(
                          ...
                          onPressed: () async {
                            await CoursesRecord.collection
                                ...
                                .set(createCoursesRecordData(
                                  courseName: _model.coursenameController.text,
                                  professor:
                                      _model.professorNameController.text,
                                  coursestart: _model.datePicked1,
                                  courseend: _model.datePicked2,
                                  coursedescription:
                                      _model.myBioController.text,
                                  coursephoto: _model.uploadedFileUrl,
